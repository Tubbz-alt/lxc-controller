...
echo
echo "Attach ~/lxc-controller/onos/lxc/onos1 at the end of /var/lib/lxc/onos1/config"
echo "Attach ~/lxc-controller/onos/lxc/onos2 at the end of /var/lib/lxc/onos2/config"
echo "Attach ~/lxc-controller/onos/lxc/onos3 at the end of /var/lib/lxc/onos3/config"
echo
echo "Start onos1, onos2, and onos3 containers"
echo
echo "Attach 'ubuntu ALL=NOPASSWD:ALL' at the end of /etc/sudoers"
